...
Parent: Medication
Id: ee-tis-medication-medical-nutrition
Description: "Eritoit. Medication resource for medical nutrition packages. Used on prescriptions NOT on dispensations."
* ^version = "1.0.0"
* ^status = #draft
* ^date = "2026-04-01T14:34:42.5909877+00:00"
* ^publisher = "TEHIK"
...
* ingredient.strengthRatio ^short = "Strenght ratio of the active ingredient. (Alati ei pruugi olla tugevust eritoidul)"
