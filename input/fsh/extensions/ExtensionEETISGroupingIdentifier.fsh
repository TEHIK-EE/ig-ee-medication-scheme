...
* . ^short = "Used when there is a need to group several identifiers to form visually one line of medication but afterwards lines could be separated as well."
...
* extension[groupingIdentifier].value[x] only id
